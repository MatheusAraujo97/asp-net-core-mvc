...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed() //método que vai servir para popular a base
        {
            ...
            Seller s1 = new Seller(1, "pessoa1", "pessoa1@teste.com", new DateTime(1998, 5, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "pessoa2", "pessoa2@teste.com", new DateTime(1998, 5, 21), 1000.0, d2);
            Seller s3 = new Seller(3, "pessoa3", "pessoa3@teste.com", new DateTime(1998, 5, 21), 1000.0, d1);
            Seller s4 = new Seller(4, "pessoa4", "pessoa4@teste.com", new DateTime(1998, 5, 21), 1000.0, d4);
            Seller s5 = new Seller(5, "pessoa5", "pessoa5@teste.com", new DateTime(1998, 4, 21), 1000.0, d3);
            Seller s6 = new Seller(6, "pessoa6", "pessoa5@teste.com", new DateTime(1998, 4, 21), 1000.0, d2);
